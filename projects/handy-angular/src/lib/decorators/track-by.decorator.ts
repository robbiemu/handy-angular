...
export function AddTrackBy(customProps?: string) {
  return function(constructor: Function) {
      constructor.prototype.trackBy = new TrackBy(customProps);
  };
}
...
**
*/
export class TrackBy<T extends {[key: string]: string}> {
  ...
  customProperty(_index: number, item: T): string {
